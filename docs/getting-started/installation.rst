...
Executables are provided for a limited number of Ubuntu versions. For other Linux flavours, you have to compile it yourself. Instructions are provided on the `GitHub wiki <https://github.com/atmoswing/atmoswing/wiki>`.
